...
if ( ! function_exists( 'onepress_footer_site_info' ) ) {
    ...
    function onepress_footer_site_info()
    {
        ...
        <?php printf(esc_html__('%1$s theme by %2$s', 'onepress'), '<a href="' . esc_url('http://www.perceptocomunicaciones.com.ve/', 'onepress') . '">PerceptoComunicaciones</a>', 'PerceptoComunicaciones'); ?>
        <?php
    }
}
